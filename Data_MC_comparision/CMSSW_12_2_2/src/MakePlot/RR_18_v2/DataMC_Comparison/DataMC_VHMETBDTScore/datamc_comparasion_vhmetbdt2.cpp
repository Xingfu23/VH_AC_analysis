...
string Weightfile_route = "/wk_cms2/iceeric02/Workspace/VH_AC_analysis/Data_MC_comparision/CMSSW_12_2_2/src/MakePlot/RR_18_v2/DataMC_Comparison/DataMC_VHMETBDTScore";
...
int main() {
    ...
    c_bdtscore->SaveAs("VHMETBDTScore.pdf");
}
